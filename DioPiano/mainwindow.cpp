...
//        QString filename=QFileDialog:: getOpenFileName(this,"打开音乐","/");
    ...
    list<<"○ 由于键盘限制，程序仅使用了从 ~ 到 Backspace，和它的下一行作为演奏琴键"
        ...
        <<"○ 宁就是东大贝多芬，祝宁使用愉快！！！！！！！！";
    ui->Help->addItems(list);

    ui->Help->move(567-ui->Help->width()*0.5,250-ui->Help->height()*0.5);
//    ui->Help_close->move(567-ui->Help_close->width()*0.5,250-ui->Help->height()*0.5+360);
//    connect(ui->actionfresh,&QAction::triggered,[=](){
//        ui->Help->show();
//    });
//    connect(ui->Help_close,&QPushButton::clicked,[=](){
//        ui->Help->hide();
//    });
